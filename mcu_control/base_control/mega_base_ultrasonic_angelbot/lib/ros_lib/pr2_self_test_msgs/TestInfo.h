...
namespace pr2_self_test_msgs
{
  ...
  class TestInfo : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      uint32_t length_test_name = strlen(this->test_name);
      ...
      *(outbuffer + offset + 0) = (u_test_status.base >> (8 * 0)) & 0xFF;
      ...
      uint32_t length_bay_name = strlen(this->bay_name);
      ...
      uint32_t length_machine = strlen(this->machine);
      ...
      *(outbuffer + offset + 3) = (u_breaker.base >> (8 * 3)) & 0xFF;
      ...
      uint32_t length_power_status = strlen(this->power_status);
