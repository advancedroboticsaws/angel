...
static const char ASSOCTF[] = "dynamic_tf_publisher/AssocTF";
  ...
  class AssocTFRequest : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      memcpy(outbuffer + offset, &length_parent_frame, sizeof(uint32_t));
      offset += 4;
      ...
      memcpy(outbuffer + offset, &length_child_frame, sizeof(uint32_t));
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      memcpy(&length_parent_frame, (inbuffer + offset), sizeof(uint32_t));
      offset += 4;
      ...
      memcpy(&length_child_frame, (inbuffer + offset), sizeof(uint32_t));
      offset += 4;
